...
<style>
    ...
    /* Optional: Style the text color in sidebar for better visibility */
...
menu_page = st.sidebar.radio("Go to", ["Search", "Song Selection", "Recommendations"], key="navigation", index=["Search", "Song Selection", "Recommendations"].index(st.session_state['page']))
